...
\begin{figure}[tbp]
    ...
    \caption{\textbf{Mapping of needs, sub-needs, relevant existing tools, and broader generative tool categories} We find that users broadly face 4 challenges: .}
