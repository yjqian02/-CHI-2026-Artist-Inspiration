...
The sharing of challenges (summarized in Table \ref{tab:phase1-summary}) allowed participants to give feedback on and refine our taxonomy. 
...
To minimize discomfort, we also warned participants that although our team would not explicitly collect data from their art pieces, the underlying models may not guarantee the same. 
We asked participants to reflect on how prototypes could help their workflow, aspects that could be improved, and other concerns they had when interacting with each prototype. These reflections were written down prior to workshops. 
We then used these reflections to inform how we would facilitate co-design workshops. Participants were compensated with \$20 USD for participation in the onboardings sessions as well as an additional \$20 for an estimated 30-45 minutes of interaction with our prototypes on their own time. 
